...
$middleware = array_merge(\Config::get('lfm.middlewares'), [
    '\FeiLongCui\LaravelFileManager\Middlewares\MultiUser',
    '\FeiLongCui\LaravelFileManager\Middlewares\CreateDefaultFolder',
]);
$prefix = \Config::get('lfm.url_prefix', \Config::get('lfm.prefix', 'laravel-file-manager'));
$as = 'feilongcui.lfm.';
