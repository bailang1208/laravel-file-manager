...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('vendor/laravel-file-manager/img/folder.png') }}">
  ...
  <link rel="stylesheet" href="{{ asset('vendor/laravel-file-manager/css/mfb.css') }}">
...
<body>
  <div class="container-fluid" id="wrapper">
    <div class="panel panel-primary hidden-xs">
      <div class="panel-heading">
        <h1 class="panel-title">{{ trans('laravel-file-manager::lfm.title-panel') }}</h1>
      </div>
    </div>
    <div class="row">
        ...
        <nav class="navbar navbar-default" id="nav">
          <div class="navbar-header">
            ...
            <a class="navbar-brand clickable hide" id="to-previous">
              ...
              <span class="hidden-xs">{{ trans('laravel-file-manager::lfm.nav-back') }}</span>
            </a>
            <a class="navbar-brand visible-xs" href="#">{{ trans('laravel-file-manager::lfm.title-panel') }}</a>
          </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                  {{ trans('laravel-file-manager::lfm.nav-sort') }} <span class="caret"></span>
                </a>
                <ul class="dropdown-menu">
                  <li>
                    <a href="#" id="list-sort-alphabetic">
                      <i class="fa fa-sort-alpha-asc"></i> {{ trans('laravel-file-manager::lfm.nav-sort-alphabetic') }}
                    </a>
                  </li>
                  <li>
                    <a href="#" id="list-sort-time">
                      <i class="fa fa-sort-amount-asc"></i> {{ trans('laravel-file-manager::lfm.nav-sort-time') }}
                    </a>
                  </li>
                </ul>
              </li>
      ...
      <ul id="fab">
        <li>
          ...
          <ul class="hide">
            <li>
              <a href="#" id="add-folder" data-mfb-label="{{ trans('laravel-file-manager::lfm.nav-new') }}">
                <i class="fa fa-folder"></i>
              </a>
            </li>
            <li>
              <a href="#" id="upload" data-mfb-label="{{ trans('laravel-file-manager::lfm.nav-upload') }}">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
            ...
            <div class="form-group" id="attachment">
              ...
              <div class="controls text-center">
                <div class="input-group" style="width: 100%">
                  <a class="btn btn-primary" id="upload-button">{{ trans('laravel-file-manager::lfm.message-choose') }}</a>
                </div>
              </div>
            </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">{{ trans('laravel-file-manager::lfm.btn-close') }}</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="lfm-loader">
    <img src="{{asset('vendor/laravel-file-manager/img/loader.svg')}}">
  </div>
  ...
  <script src="{{ asset('vendor/laravel-file-manager/js/jquery.form.min.js') }}"></script>
  ...
  <script>
    ...
    $('#fab').fab({
      buttons: [
        {
          icon: 'fa fa-folder',
          label: "{{ trans('laravel-file-manager::lfm.nav-new') }}",
          attrs: {id: 'add-folder'}
        },
        {
          icon: 'fa fa-upload',
          label: "{{ trans('laravel-file-manager::lfm.nav-upload') }}",
          attrs: {id: 'upload'}
        }
      ]
    });
